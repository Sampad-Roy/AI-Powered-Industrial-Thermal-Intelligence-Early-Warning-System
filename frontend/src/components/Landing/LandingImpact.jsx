  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 landing-container">
        ...
        {/* Heading */}
        <h2 className="reveal font-serif font-bold text-[2.2rem] sm:text-[2.8rem] md:text-[3.2rem] text-white tracking-tight leading-[1.15] mb-6 max-w-3xl">
          Towards a Safer, Cleaner<br className="hidden sm:block" />
          and More Sustainable Future
        </h2>

        {/* Description */}
        <p className="reveal font-sans text-[1.05rem] sm:text-[1.15rem] text-slate-200/90 leading-relaxed mb-10 max-w-2xl">
        ...
        <div className="reveal mb-16">
          <button
            ...
            className="px-7 py-3.5 rounded-xl font-sans font-bold text-[13.5px] text-[#173042] bg-[#EDEBE3] hover:bg-white transition-all duration-200 shadow-lg hover:shadow-xl hover:-translate-y-0.5 inline-flex items-center gap-2.5 cursor-pointer group"
          >
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 pt-10 border-t border-white/15">
          {metrics.map((m, i) => (
            <div
              key={i}
              className={`reveal ${delayClass[i]} bg-white/8 backdrop-blur-sm border border-white/12 rounded-xl p-5 text-left`}
            >
