...
export default function InvestigationView() {
  ...
  return (
    <div className="flex-1 p-5 overflow-y-auto bg-[#040813] space-y-4 select-none">
      ...
      <div className="p-4 rounded-xl bg-[#081020] border border-[#1a2b48] flex flex-wrap items-center justify-between gap-4 shadow-xl">
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] font-mono px-2 py-0.5 rounded bg-cyan-950 text-cyan-300 border border-cyan-800 font-bold shadow-sm">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <select
            ...
            className="select-tactical text-xs py-1.5 px-3 bg-[#0a1222] border border-[#1c2e4d] text-slate-200 cursor-pointer max-w-xs"
          >
            {events.map((item) => (
          ...
          <button
            ...
            className="btn-tactical text-xs px-3.5 py-1.5 bg-[#0e1b32] hover:bg-cyan-950 text-cyan-300 border-cyan-800 hover:border-cyan-400 shadow-sm"
          >
      ...
      <div className="p-3.5 rounded-xl bg-[#081020] border border-[#1a2b48] shadow-lg flex flex-wrap items-center justify-between gap-3 animate-fadeIn">
        ...
        <div className="text-right text-[11px] font-mono text-slate-400">
          ...
          <span className="text-[10px] text-cyan-400/80">CRS: EPSG:4326 (WGS84)</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
        ...
        <div className="lg:col-span-6 space-y-4">
          ...
          <div className="p-4 rounded-xl bg-[#081020] border border-[#1a2b48] space-y-3 shadow-lg">
            <div className="flex items-center justify-between pb-2 border-b border-[#16233b]">
            ...
            {/* Probabilities */}
            <div className="space-y-2 pt-2 border-t border-[#16233b]">
                ...
                Object.entries(ev.class_probabilities).map(([cls, prob]) => {
                  ...
                  return (
                    <div key={cls} className="space-y-1">
                      ...
                      <div className="w-full bg-[#101c33] rounded-full h-1.5 overflow-hidden">
                        <div
          ...
          <div className="p-4 rounded-xl bg-[#081020] border border-[#1a2b48] space-y-3 shadow-lg">
            ...
            <div className="grid grid-cols-2 gap-3 font-mono text-xs">
              <div className="p-3 rounded-lg bg-[#050b17] border border-[#16233b] shadow-inner">
              ...
              <div className="p-3 rounded-lg bg-[#050b17] border border-[#16233b]">
            ...
            <div className="flex justify-between text-xs font-mono text-slate-400 pt-2 border-t border-[#16233b]">
          ...
          <div className="p-4 rounded-xl bg-[#081020] border border-[#1a2b48] space-y-2.5 shadow-lg">
            <span className="text-xs font-mono font-bold uppercase text-slate-200 flex items-center gap-1.5">
        ...
        <div className="lg:col-span-6 space-y-4">
          ...
          <div className="p-4 rounded-xl bg-[#09152b] border border-cyan-800/60 space-y-3 shadow-xl">
            ...
            <div className="space-y-2.5">
              {ev.top_shap_explanations &&
                ev.top_shap_explanations.map((shap, idx) => {
                  ...
                  return (
                    <div key={idx} className="p-2.5 rounded-lg bg-[#050b17] border border-[#16233b] space-y-1 shadow-sm">
          ...
          >
            <div className="flex items-center gap-2 mb-1.5">
              ...
              <span className="font-heading font-bold text-sm" style={{ color: riskCfg.color }}>
